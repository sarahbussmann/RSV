...
colnames(RSV_X) <- c("Age_25","CS1_25","R1_25","WEL1_25","INSLT1_25","Age_50","CS1_50","R1_50","WEL1_50","INSLT1_50","Age_75",
                     "CS1_75","R1_75","WEL1_75","INSLT1_75")
...
write.csv(Difference, file="difference_ThreeQuantiles_New9RealAttributes_tx13.csv", row.names=FALSE)
write.csv(attributes, file="attributes_ThreeQuantiles_New9RealAttributes_tx13.csv", row.names=FALSE)