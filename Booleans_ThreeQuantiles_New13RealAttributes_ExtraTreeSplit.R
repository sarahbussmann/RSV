...
write.csv(Difference, file="difference_ThreeQuantiles_New13RealAttributes_tx25_ExtraTreeSplit.csv", row.names=FALSE)
write.csv(attributes, file="attributes_ThreeQuantiles_New13RealAttributes_tx25_ExtraTreeSplit.csv", row.names=FALSE)