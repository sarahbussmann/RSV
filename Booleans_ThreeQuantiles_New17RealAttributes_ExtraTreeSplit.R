...
write.csv(Difference, file="difference_ThreeQuantiles_New17RealAttributes_tx37_ExtraTreeSplit.csv", row.names=FALSE)
write.csv(attributes, file="attributes_ThreeQuantiles_New17RealAttributes_tx37_ExtraTreeSplit.csv", row.names=FALSE)