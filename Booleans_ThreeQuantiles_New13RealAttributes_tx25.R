...
Sorted_reals <- subset(SortByTime, select = c(CS2, R2, WEL2, INSLT2, CS3, R3, WEL3, INSLT3))
...
write.csv(Difference, file="difference_ThreeQuantiles_New13RealAttributes_tx25.csv", row.names=FALSE)
write.csv(attributes, file="attributes_ThreeQuantiles_New13RealAttributes_tx25.csv", row.names=FALSE)